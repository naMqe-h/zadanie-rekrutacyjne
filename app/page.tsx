...
export default function Home() {
  ...
  return (
    <div className="w-screen h-screen pt-10 bg-[#f5f5f5] flex justify-center">
      {menuItems.length === 0 ? (
        isAddingNew ? (
          <AddMenuItems setIsAdding={setIsAddingNew} menuItems={menuItems} setMenuItems={setMenuItems} />
        ) : (
        ...
        <div className="w-[1170px] h-fit flex flex-col rounded-lg border border-[#D0D5DD]">
          ...
          {isAddingNext && <AddMenuItems setIsAdding={setIsAddingNext} menuItems={menuItems} setMenuItems={setMenuItems} isAddingNext={true} />}
