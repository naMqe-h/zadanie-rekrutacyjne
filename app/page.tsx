      ...
      <div className="w-[1170px] h-fit flex flex-col rounded-lg border border-[#D0D5DD]">
        ...
        <div className="w-full h-[80px] bg-[#f5f5f5] rounded-b-lg flex items-center py-5 px-6">
          <button 
            ...
            className="w-[178px] h-[40px] px-[14px] py-[10px] flex items-center justify-center rounded-lg bg-[#ffffff] text-[#344054] text-sm font-semibold border border-[#D0D5DD]"
          >
